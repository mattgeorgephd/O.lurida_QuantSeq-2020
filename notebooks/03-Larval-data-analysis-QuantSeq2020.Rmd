...
dds.larvae <- DESeqDataSetFromMatrix(countData = counts.tsk.larvae[,grepl("OLUR", colnames(counts.tsk.larvae))] %>% t(),
                              colData = counts.tsk.larvae[,c("population", "pCO2.parent", "week.collected", "larval.day.collected")],
                              design = ~ week.collected + population + pCO2.parent)
```
...
```{r}
# PCA with points color coded by week larvae were collected 
ggplotly(
plotPCA(vsd.larvae, intgroup="week.collected") + 
...
# PCA with points color coded by week collected & parental pCO2 exposure 
ggplotly(
plotPCA(vsd.larvae, intgroup=c("week.collected", "pCO2.parent")) + 
           ggtitle("PCA by parental pCO2 exposure (var-stabilizing transformed)") + 
  geom_point(size=3, aes(text=colnames(vsd.larvae))) + theme_minimal(), tooltip = "text")
...
# PCA with points color coded by week collected, population, and pco2 factors 
ggplotly(
plotPCA(vsd.larvae, intgroup=c("population","pCO2.parent")) + 
           ggtitle("PCA by population + parental pCO2 (var-stabilizing transformed)") + 
